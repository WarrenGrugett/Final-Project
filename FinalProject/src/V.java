...
public class V {
	...
	// Costs of all towers
	public static final double CANNON_COST = 4, CHIPPER_COST = 5, TANK_COST = 7, GENERATOR_COST = 6;
	// Costs of all troops
	public static final double ARCHER_COST = 3, GIANTWARRIOR_COST = 6, KNIGHT_COST = 4, MACHINIST_COST = 6;
