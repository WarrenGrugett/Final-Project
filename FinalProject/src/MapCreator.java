...
public class MapCreator extends PApplet
{
   ...
   { "Path Tile", "Wall Tile", "Enemy Start Location", "Player Start Location", "Select Map Background",
         "Set Map Dimensions" };

   /**
    * 
    * @param Window w that will be used
    */
   ...
   /**
    * Draws all components from MapCreator to screen
    * overrides PApplet draw
    */
   public void draw()
   {
      ...
      if (!troopSelect)
         drawMapCreator();
      else drawTroopSelector();
   }

   /**
    * Background obtained from directory 
    */
